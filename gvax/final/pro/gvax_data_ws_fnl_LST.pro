PRO gvax_data_ws_fnl_LST

COMPILE_OPT IDL2
 
infile = '/home/jd/GVAX_data/final/f_ws_local_hrly.dat'
...
FOR m = 0,23 DO BEGIN 
j = WHERE(yy GT 20110630 AND yy LE 20110731 AND hh EQ m+.5, jcount)
jul[m] = mean(ws[j])
...
fout = '/home/jd/GVAX_data/final/ws_hly1_lst.dat'
...
FREE_LUN, lun
print, june
fout = '/home/jd/GVAX_data/final/ws_hly2_lst.dat'
